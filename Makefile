webserv: webserv.o helper.o servreq.o reqhead.o resphead.o resource.o logger.o
	gcc -o webserv webserv.o helper.o servreq.o reqhead.o resphead.o resource.o logger.o -Wall
